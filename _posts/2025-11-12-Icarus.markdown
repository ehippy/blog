...
## Mothership
<img src="{% asset 'mothership.png' @path %}"
...
<img src="{% asset 'Ypsilon-14.png' @path %}    "
...
<div style="float:right;margin-left:20px;">
    <img src="{% asset 'icarusRefinements.gif' @path %}" alt="Animated refinements to the layout" />
</div>
...
[![Cover art for Icarus, featuring a burning star]({% asset 'IcarusItchCoverWithAwards.png' @path %})](https://kinggeekus.itch.io/icarus)
...
<div style="display: flex; gap: 10px; justify-content: center;">
    <img src="{% asset 'triptech_Minerva.png' @path %}" alt="Minerva" style="width: 33%;" />
    <img src="{% asset 'triptech_NeonDreamGirl.png' @path %}" alt="Neon Dream Girl" style="width: 33%;" />
    <img src="{% asset 'triptech_Xiao.png' @path %}" alt="Xiao" style="width: 33%;" />
</div>
