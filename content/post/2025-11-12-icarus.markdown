...
<div style="float:right;width:15%; margin-left: 20px;">
  {{< picture src="mothership.png" alt="Mothership Players Survival Guide" >}}
</div>
...
<div style="float:left;width:20%; margin-right: 20px;">
  {{< picture src="Ypsilon-14.png" alt="The Haunting of Ypsilon-14" >}}
</div>
...
{{< picture src="icarusNotes.png" alt="Notes about icarus" >}}
...
<div style="float:right;margin-left:20px;">
    {{< picture src="icarusRefinements.gif" alt="Animated refinements to the layout" >}}
</div>
...
<a href="https://kinggeekus.itch.io/icarus">{{< picture src="IcarusItchCoverWithAwards.png" alt="Cover art for Icarus, featuring a burning star" >}}</a>
...
<div style="display: flex; gap: 10px; justify-content: center;">
    <div style="width: 33%;">
      {{< picture src="triptech_Minerva.png" alt="Minerva" >}}
    </div>
    <div style="width: 33%;">
      {{< picture src="triptech_NeonDreamGirl.png" alt="Neon Dream Girl" >}}
    </div>
    <div style="width: 33%;">
      {{< picture src="triptech_Xiao.png" alt="Xiao" >}}
    </div>
</div>
...
{{< picture src="icarusOnTheTable.jpg" alt="Dads rolling dice" >}}
