...
<div style="float:right;width:200px;border-radius:20px;overflow:hidden;box-shadow: rgba(149, 157, 165, 0.4) 0px 8px 24px; margin-left: 20px;">
  {{< picture src="oldInfights.png" alt="Many old false starts at infight" >}}
</div>
...
{{< picture src="infightScreenshot.png" alt="An infight.io game board" >}}
...
{{< picture src="infightSlackShot.png" alt="Screenshot of discord with Infight interactions" >}}
