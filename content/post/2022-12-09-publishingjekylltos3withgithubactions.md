...
deploy:
    ...
```
{{< picture src="brokeTwoThings.png" alt="Incorrectly parallel step process graphic" >}}]
...
{{< picture src="brokeTwoThingsTwo.png" alt="Two step process graphic" >}}]
...
{{< picture src="gitHubActnSecrets.png" alt="Secrets configuration screenshot" >}}]
...
{{< picture src="twoThings.png" alt="Incorrectly parallel step process graphic" >}}]
